...
public interface IRepositoryBase<TId, TEntity> where TEntity : EntityBase<TId>
{
    ...
    Task<IEnumerable<TEntity>> GetAllAsync(Expression<Func<TEntity, bool>>? filters = null, IncludeOptions<TEntity>? includeOptions = null);
    ...
    Task<TEntity?> GetAsync(Expression<Func<TEntity, bool>> filters, IncludeOptions<TEntity>? includeOptions = null);
    ...
    Task<PaginationResult<TEntity>> GetPagedAllAsync(int pageNumber, int pageSize, Expression<Func<TEntity, bool>>? filters = null, IncludeOptions<TEntity>? includeOptions = null);
